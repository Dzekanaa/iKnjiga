...
export const LogIn = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!res) {
      return alert("Došlo je do greške prilikom prijave.");
    }
            ...
            <div className="py-10 px-12 bg-background mx-auto shadow-md shadow-primary rounded-2xl">
              <div className="mb-4 text-center space-y-2">
                ...
                <p className="text-gray-500">
                  Unesi podatke radi prijave na svoj nalog.
                </p>
              </div>
              <form className="space-y-5 pt-4" onSubmit={handleSubmit}>
                ...
                <div className=" form-control">
                  ...
                  <label className="label label-text">
                    <Link to="/register" className=" label-text text-text">
                      Nemaš Nalog?
                ...
                <div className="form-control">
                  <button className="btn mt-2 btn-primary">Prijavi se</button>
                </div>
              </form>
